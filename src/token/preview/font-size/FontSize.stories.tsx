const Page = () => (
  <div className="preview-page">
    ...
    <div className="font-sizes font-sizes-display">
      ...
      <span className="font-size font-size-display-l">Font Size Display L</span>

      <span className="font-size font-size-display-m">Font Size Display M</span>

      <span className="font-size font-size-display-s">Font Size Display S</span>
